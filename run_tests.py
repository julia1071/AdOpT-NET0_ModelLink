...
if execute == 1:
    ...
    for i, interval in enumerate(intervals):
        ...
        pyhub[interval].read_data(casepath_interval, start_period=0, end_period=2)
        ...
        set_negative_CO2_limit(pyhub[interval], interval, ["SteamReformer", "WGS_m", "SteamReformer_existing", "WGS_m_existing"])
