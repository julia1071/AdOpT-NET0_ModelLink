...
from ..genericTechnologies import fitting_classes as f
...
class Conv1(Technology):
    ...
    **Constraint declarations:**
    ...
    def __init__(self, tec_data: dict):
        ...
        self.component_options.size_based_on = tec_data["size_based_on"]
        ...
        if self.component_options.performance_function_type == 1:
            self.fitting_class = f.FitGenericTecTypeType1(self.component_options)
        elif self.component_options.performance_function_type == 2:
            self.fitting_class = f.FitGenericTecTypeType2(self.component_options)
        elif (
            self.component_options.performance_function_type == 3
            or self.component_options.performance_function_type == 4
        ):
            self.fitting_class = f.FitGenericTecTypeType34(self.component_options)
        else:
            raise Exception(
    ...
    def fit_technology_performance(self, climate_data: pd.DataFrame, location: dict):
        ...
        temp = copy.deepcopy(
            self.input_parameters.performance_data["performance"]["out"]
        )
        self.input_parameters.performance_data["performance"]["out"] = {}
        self.input_parameters.performance_data["performance"]["out"]["out"] = temp
    ...
    def construct_tech_model(self, b_tec, data: dict, set_t_full, set_t_clustered):
        ...
        def init_size_constraint(const, t):
            if self.component_options.size_based_on == "input":
                return (
                    sum(
            ...
            elif self.component_options.size_based_on == "output":
                return (
                    sum(
                ...
                for car in self.component_options.input_carrier:
                    if not car == self.component_options.main_input_carrier:
                       bounds_rr_full["input"][car] = (
                                bounds_rr_full["input"][self.component_options.main_input_carrier]
