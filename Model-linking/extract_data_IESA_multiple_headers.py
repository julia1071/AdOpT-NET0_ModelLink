...
def extract_data_IESA_multiple(results_file_path):
    """
    ...
    Args:
        intervals (list): Year intervals to extract (e.g., [2020, 2030])
        list_sheets (list): Sheet names to read
        nrows (list): Rows to read per sheet
        filters (list): Filter values (str or tuple) per sheet
        headers (list): Column names (str or tuple) used as filters
